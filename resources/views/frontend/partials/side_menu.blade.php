...
@foreach($categories as $category)
    <li class="mb-1">
      ...
      <button class="btn btn-toggle align-items-center rounded collapsed" data-bs-toggle="collapse" data-bs-target=".{{'abir'.$category->id}}" aria-expanded="false">
        {{$category->name}}
      </button>     
      @else
      ...
      @endif
      <div class="collapse {{'abir'.$category->id}}">
